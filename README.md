...
- **Next** move into our `actions/index.js` file to build out theyarn action that will be sending off the `axios` request to the `SWAPI` api, the URL is `https://swapi.co/api/people`.
